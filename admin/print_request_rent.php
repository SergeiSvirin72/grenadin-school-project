	...
	<div class="wrapper">
			...
			<section class="content">
				<section class="request">
					<div class="container">
						...
						<b class="print-b">Просим зарегистрировать в качестве участника и предоставить в аренду торговую точку</b>
						<table>
							<tbody>
								<tr>
									<th>Вид продукции</th>
									<th>Кол-во торговых точек</th>
									<th>Ширина, м</th>
									<th>Длина, м</th>
								</tr>
								<tr style="text-align: center;">
									<td><?php echo $row['product_type'];?></td>
									<td><?php echo $row['product_spot'];?></td>
									<td><?php echo $row['product_width'];?></td>
									<td><?php echo $row['product_length'];?></td>
								</tr>
							</tbody>
						</table>
						<table>
							<tbody>
								<tr>
									<td>Кол-во потребляемой электроэнергии (кВт/час): <?php echo $row['product_electricity'];?></td>
								</tr>
								<tr>
									<td>Примечание и особые пожелания: <?php echo $row['product_notes'];?></td>
								</tr>
							</tbody>
						</table>
					</div>
		...
		<footer>
			<div class="container">
				...
				<div class="print-sign-row" style="margin-top: 16px;">
					<div>Уполномоченное лицо Заявителя</div>
					<div>_______________________    /   _______________   /   </div>
				</div>
				<div class="print-sign-row">
					<div style="flex-grow: 1;">« ___ »_______________  2019 г. </div>
