						...
						<div class="form-section">
							<div class="form-row">
								<div class="form-group">
									...
									<textarea class="form-control" readonly><?php echo $row['performance_description'];?></textarea>
								</div>
							</div>
							<div class="form-row">
								<div class="form-group">
									<label>Время выступления</label>
									<input type="text" value="<?php echo $row['performance_time'];?>" class="form-control" readonly>
								</div>
							</div>
						</div>
					</form>				
